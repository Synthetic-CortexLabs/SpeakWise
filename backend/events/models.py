...
class Event(models.Model):
    ...
    organizers = models.ManyToManyField('organizers.Organizer', related_name='events')
    speakers = models.ManyToManyField('speakers.Speaker', related_name='events')
    talks = models.ManyToManyField('talks.Talks', related_name='events')
