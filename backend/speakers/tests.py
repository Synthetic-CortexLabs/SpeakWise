...
class SpeakerSerializerTest(TestCase):
    ...
    def test_contains_expected_fields(self):
        ...
        self.assertCountEqual(data.keys(), ["user_id", "twitter", "organization", "avatar","bio", "id","create_at","update_at"])
...
class SpeakerAPITest(APITestCase):
    def setUp(self):
        self.user = User.objects.create_user(username="testuser", password="password123")
        self.user2 = User.objects.create_user(username="testsuser", password="password123")
